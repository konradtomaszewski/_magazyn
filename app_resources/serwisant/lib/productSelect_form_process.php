...
echo "<h4>Wybrane urządzenie</h4><input type='test' disabled='disabled' name='product_name' value='".$_POST['product_name']."'>";
//echo "<br /><br /><h4>Numer seryjny</h4><input type='test' disabled='disabled' name='sn' value='".$_POST['sn']."'>";
echo "<br /><br /><h4>Ilość</h4><input type='number' name='quantity' max='".$_POST['quantity']."' min='1' value='1'><b>MAX: ".$_POST['quantity']."</b>";

echo "<br /><br /><h4>Status</h4><select id='service_status'>";
...
echo "<div id='automat_number'><br /><br /><h4>Inormacja o automacie</h4>
		<input type='text' name='bus_number'  placeholder='Wprowadź numer pojazdu'/><br /><br />
